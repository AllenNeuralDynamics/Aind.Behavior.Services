...
We will strictly follow the logging standards defined by [Harp](https://harp-tech.org/articles/python.html#data-models). This decision is justified by the following reasons:
