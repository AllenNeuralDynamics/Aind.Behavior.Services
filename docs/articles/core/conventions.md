...
All `datetime` used in data formats should follow the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) standard. This standard is widely used and supported by most programming languages and libraries. All `datetime` are expected to be timezone aware, or UTC if no timezone information is provided. We encourage the following pattern:
...
`CSV` files will follow a subset of the [RFC 4180](https://tools.ietf.org/html/rfc4180) standard.
